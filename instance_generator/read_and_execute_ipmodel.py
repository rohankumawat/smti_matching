...
if __name__ == "__main__":
    directory_path = "../experiments/men_have_strictly_ordered_lists/large_instances/instances_size_400"
    output_file_path = "../experiments/men_have_strictly_ordered_lists/results/ip_model_size_400.txt"
